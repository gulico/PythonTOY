...
def getData(baseURL):
    ...
    for i in range(36, 142):  # n页人，每页25帖
        ...
        for j in range(1, 26):  # 遍历每页25个帖子
            ...
            try:
                ...
                for page in range(0, int(int(reply_count) / 100) + 1):  # 遍历帖子
                    ...
                    topic_html_page = askURL(topic_url_page)
                    count += 1
...
def askURL(url):
    # 数据头，伪装浏览器
    cookie_info = [
        'douban-fav-remind=1; _vwo_uuid_v2=D98484F3513B163F539656BA2F6A8DE51|db2c768bb07b9f13eef10390c0a60413; __gads=ID=ac84f573b549c2d9:T=1570668553:S=ALNI_MZHP-oU0A9pgzkM8aDMvNcdt6k8jQ; douban-profile-remind=1; gr_user_id=9bc17822-5856-494b-a366-5c5e46d6bcf7; _ga=GA1.2.1623359302.1569843891; ll="118172"; bid=ByTvLwM3R-Y; __yadk_uid=z5tIITZHJyKnSfmfXHnc49KrGogSy6Ss; __utmv=30149280.867; ct=y; __utmz=30149280.1619427712.390.9.utmcsr=baidu|utmccn=(organic)|utmcmd=organic; __utmc=30149280; push_doumail_num=0; _pk_ref.100001.8cb4=%5B%22%22%2C%22%22%2C1620538432%2C%22https%3A%2F%2Fwww.google.com%2F%22%5D; _pk_ses.100001.8cb4=*; ap_v=0,6.0; __utma=30149280.1623359302.1569843891.1620479882.1620538433.444; dbcl2="8679427:/df1BdlWpYE"; ck=_Ead; push_noty_num=0; __utmt=1; _pk_id.100001.8cb4=d9893e1ac327953c.1569843890.2229.1620539617.1620482110.; __utmb=30149280.40.3.1620539617344',
        '__utma=30149280.1672118031.1620539799.1620539799.1620539799.1; __utmb=30149280.39.6.1620540069661; __utmc=30149280; __utmv=30149280.18987; __utmz=30149280.1620539799.1.1.utmcsr=baidu|utmccn=(organic)|utmcmd=organic; push_doumail_num=0; push_noty_num=0; _pk_id.100001.8cb4=f3868e338ec3a9fb.1620539798.1.1620540069.1620539798.; _pk_ses.100001.8cb4=*; douban-fav-remind=1; __yadk_uid=HkI9bCMBM7sA79IGZCJWaAR9oBa8Ho0b; ap_v=0,6.0; ck=Domn; dbcl2="189871423:ZDquXcsxCMs"; __utmt=1; bid=oG0d-p4KEV8; ll="118172"; _pk_ref.100001.8cb4=%5B%22%22%2C%22%22%2C1620539798%2C%22https%3A%2F%2Fwww.baidu.com%2Flink%3Furl%3DbXO3Jn_qrAnz2zOu7Bt_isbETId0RpSEd8V4VocnPb-eOOYrfoMh6rWhJjQ8Es_I%26wd%3D%26eqid%3D8ba2ed86000acfef0000000560977993%22%5D'
    ]
    cookies = []
